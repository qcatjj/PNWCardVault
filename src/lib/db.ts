...
async function createPgliteSql(): Promise<Sql> {
  ...
  // — so an HMR reload after adding a migration file (e.g. 0006_shop.sql)
  // applies it live — with passes serialized on a global chain so concurrent
  // callers never double-apply.
